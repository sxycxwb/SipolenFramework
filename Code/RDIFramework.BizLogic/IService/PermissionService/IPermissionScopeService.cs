...
namespace RDIFramework.BizLogic
{
    ...
    public interface IPermissionScopeService
    {
        ...
        /// <returns>主键</returns>
        [OperationContract]
        string Add(UserInfo userInfo, PiPermissionScopeEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>实体</returns>
        [OperationContract]
        PiPermissionScopeEntity GetEntity(UserInfo userInfo, string id);
        ...
        [OperationContract]
        int Update(UserInfo userInfo, PiPermissionScopeEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>影响行数</returns>
        [OperationContract]
        int BatchSave(UserInfo userInfo, List<PiPermissionScopeEntity> entites);
