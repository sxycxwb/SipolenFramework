...
namespace RDIFramework.BizLogic
{
    ...
    /// </summary>
    [ServiceContract]
    public interface IPiUserRoleService
    {
        /// <summary>
        /// 添加实体
        /// </summary>
        ...
        /// <returns>主键</returns>
        [OperationContract]
        string Add(UserInfo userInfo, PiUserRoleEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>实体</returns>
        [OperationContract]
        PiUserRoleEntity GetEntity(UserInfo userInfo, string id);
        ...
        [OperationContract]
        int Update(UserInfo userInfo, PiUserRoleEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>影响行数</returns>
        [OperationContract]
        int BatchSave(UserInfo userInfo, List<PiUserRoleEntity> entites);
