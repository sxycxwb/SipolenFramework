...
namespace RDIFramework.BizLogic
{
    ...
    /// 修改纪录
    /// 
    ///		2012.05.18 版本：1.0	XuWangBin 创建。
    ///	
    /// 版本：1.0
    ///
    /// <author>
    ...
    public class ConstraintUtil
    {
        ...
        public static string PrepareParameter(UserInfo userInfo, string constraint)
        {
        ...
        {
            return PrepareParameter(SystemInfo.UserInfo, constraint);
        }
   }
}