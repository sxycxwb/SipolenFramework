...
namespace RDIFramework.BizLogic
{
    ...
    /// </summary>
    [Serializable]
    public partial class MainUserControlEntity : BaseEntity
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        {
            this.Id = BusinessLogic.ConvertToString(dataRow[MainUserControlTable.FieldId]);
            this.FullName = BusinessLogic.ConvertToString(dataRow[MainUserControlTable.FieldFullName]);
            this.Description = BusinessLogic.ConvertToString(dataRow[MainUserControlTable.FieldDescription]);
            this.Type = BusinessLogic.ConvertToString(dataRow[MainUserControlTable.FieldType]);
