...
namespace RDIFramework.BizLogic
{
    ...
    ///        2014-07-30 版本: 2.8 XuWangBin 以自动属性进行重新组织。
     ...
     /// </summary>
    [Serializable]
    public partial class PiPermissionScopeEntity : BaseEntity
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        {
            this.Id = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldId]);
            ...
            this.PermissionId = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldPermissionId]);
            this.PermissionConstraint = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldPermissionConstraint]);
            this.StartDate = BusinessLogic.ConvertToNullableDateTime(dataRow[PiPermissionScopeTable.FieldStartDate]);
            this.EndDate = BusinessLogic.ConvertToNullableDateTime(dataRow[PiPermissionScopeTable.FieldEndDate]);
            this.Enabled = BusinessLogic.ConvertToNullableInt(dataRow[PiPermissionScopeTable.FieldEnabled]);
            this.DeleteMark = BusinessLogic.ConvertToNullableInt(dataRow[PiPermissionScopeTable.FieldDeleteMark]);
            this.Description = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldDescription]);
            this.CreateOn = BusinessLogic.ConvertToNullableDateTime(dataRow[PiPermissionScopeTable.FieldCreateOn]);
            ...
            this.ModifiedOn = BusinessLogic.ConvertToNullableDateTime(dataRow[PiPermissionScopeTable.FieldModifiedOn]);
            this.ModifiedBy = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldModifiedBy]);
            this.ModifiedUserId = BusinessLogic.ConvertToString(dataRow[PiPermissionScopeTable.FieldModifiedUserId]);
            return this;
        }
    }
}
