...
namespace MiniBrowser
{
    partial class BrowserControl : UserControl
    {
        ...
        void _browser_StartNewWindow(object sender, BrowserExtendedNavigatingEventArgs e)
        {
            ...
            MiniBrowser mf = GetMainFormFromControl(sender as Control);
            if (mf == null)
                return;
        ...
        private static MiniBrowser GetMainFormFromControl(Control control)
        {
            while (control != null)
            {
                if (control is MiniBrowser)
                    break;
                control = control.Parent;
            }
            return control as MiniBrowser;
        }
