...
namespace MiniBrowser
{
    ...
    partial class MiniBrowser : RDIFramework.WinForm.Utilities.BaseForm
    {
        public MiniBrowser()
        {
            InitializeComponent();
        ...
        {
            using (AboutForm of = new AboutForm())
            {
                of.ShowDialog(this);
            }
        }
        ...
        public void OpenNewURL(Uri url)
        {
            this._windowManager.Open(url);
        }
    }
}