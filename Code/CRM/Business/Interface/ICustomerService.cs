...
namespace CRM
{
    ...
    public interface ICustomerService
    {
        ...
        /// <returns>主键</returns>
        [OperationContract]
        string Add(UserInfo userInfo, CustomerEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>实体</returns>
        [OperationContract]
        CustomerEntity GetEntity(UserInfo userInfo, string id);
        ...
        /// <returns>数据表</returns>
        [OperationContract]
        DataTable GetCustomerContactInfo(UserInfo userInfo, string id);
        ...
        [OperationContract]
        int Update(UserInfo userInfo, CustomerEntity entity, out string statusCode, out string statusMessage);
        ...
        /// <returns>数据表</returns>
        [OperationContract]
        DataTable GetDTByCategory(UserInfo userInfo, string category = "");
