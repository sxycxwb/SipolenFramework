...
namespace RDIFramework.WinModule
{
    ...
    /// 
    /// 修改记录
    ///     2015-01-22 XuWangBin V3.0 新增离职管理，访问日志功能 。
    ///     2015-07-18 XuWangBin V3.0 修改无用户数据时不能增加用户的问题。
    ///     2015-01-04 王进   V2.9 删除未使用的方法。
    ///     2014-05-06 XuWangBin V2.8 增加导出功能。
    ///     2014-04-26 XuWangBin V2.8 增加按组织机构来加载用户并以分页的形式展示，这样就可以满足大批量用户展示的请求。
    ///     2013-06-18 XuWangBin 版本2.5 新增对“有效”、“无效”、“全部用户”的搜索功能。
    ///     2012-05-26 XuWangBin 版本2.1 修改：当非用户管理员进入“用户管理”界面，提示排序字段不存在的问题。
    /// </summary>
