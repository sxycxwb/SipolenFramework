...
namespace RDIFramework.WinModule
{
    ...
    public partial class FrmRoleModulePermission : BaseForm
    {
        ...
        public FrmRoleModulePermission(string userId, string userRealame)
            : this()
        {
            this.txtRole.Tag = userId;
            this.txtRole.Text = userRealame;
        }
        ...
        public override void FormOnLoad()
        {
            ...
            this.ModuleIds = RDIFrameworkService.Instance.PermissionService.GetScopeModuleIdsByRoleId(UserInfo, this.txtRole.Tag.ToString(), "Resource.AccessPermission");
            // 设置鼠标默认状态，原来的光标状态
            this.BindData(true);
        ...
        private bool DoBatchSave()
        {
            ...
            RDIFrameworkService.Instance.PermissionService.GrantRoleModuleScope(UserInfo, this.txtRole.Tag.ToString(), "Resource.AccessPermission", grantModuleIds);
            RDIFrameworkService.Instance.PermissionService.RevokeRoleModuleScope(UserInfo, this.txtRole.Tag.ToString(), "Resource.AccessPermission", revokeModuleIds);
