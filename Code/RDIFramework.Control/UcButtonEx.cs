...
{    
    ...
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(UcButtonEx), "Images.UcButtonEx.png")]
    [Description("自定义的Button控件(传统样式)")]
    public class UcButtonEx : Button
    {
       #region About Constructor
        public UcButtonEx()
        {
            ...
            this.BackgroundImage = RDIFramework.Controls.Properties.Resources.ButtonBG01;
            timer1.Interval = 5;
            ...
            else
            {
                ...
                if (_keeppress)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (typeof(UcButtonEx) == _control.GetType() & _control.Name != this.Name)
                            {
                                ((UcButtonEx)(_control))._ispressed = false;
                                ((UcButtonEx)(_control)).UpdateLeave();
                            }
                        }
                    }
                    catch { }
