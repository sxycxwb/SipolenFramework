...
namespace RDIFramework.Controls
{
    ...
    /// UcCombinQuery
    /// 修改纪录
    ///     2012-03-08  XuWangBin 再次对组合查询控件进行重构，清除了相关冗余代码，新增了一种对查询项的填充。
    ///     2010-12-06  XuWangBin 优化相关代码。
    ///     2010-11-29  XuWangBin 取消对：清除组合查询控件条件时的提示。
    ///     2010-11-08  XuWangBin 要是查询项中包含"案卷号",则把案卷号移动到第一个查询项。
    ///     2010-11-05  XuWangBin 对案卷号的查询，不加单引号。
    ///     2010-09-07  XuWangBin 增加对SQL注入的判断，以防止SQL注入。
    ///     2010-08-30  XuWangBin 对查询字符型字段进行>、<、>=、<=、=操作时，其值自动加单引号。
    ///      2008-08-05 XuWangBin 创建组合查询控件
    ///     
    /// <author>
    ///     <name>XuWangBin</name>
    ///     <QQ>406590790</QQ>
