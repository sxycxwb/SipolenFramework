...
namespace RDIFramework.CodeMaker
{
    public partial class IEView : Form
    {
        ...
        public IEView(Form mdiParentForm, string url)
        {
            ...
            mainfrm.tslblPromptInfo.Text = url;
        ...
        {
            mainfrm.tslblPromptInfo.Text = "Íê³É";
            //Crownwood.Magic.Controls.TabPage page = (Crownwood.Magic.Controls.TabPage)webBrowser1.Parent.Parent;
        ...
        {
            mainfrm.tslblPromptInfo.Text = webBrowser1.StatusText;            
        }
