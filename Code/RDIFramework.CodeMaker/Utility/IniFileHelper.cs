...
namespace RDIFramework.CodeMaker
{
    ...
    public class IniFileHelper
    {
        ...
        private void LoadValues()
        {
            ...
            if ((fileName.Trim() == "") || (!File.Exists(fileName))) return;
        ...
        private void SetStrings(StreamReader sr)
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if ((splitPos > 0) && (sectionsKeys != null))
                        {
                            ...
                            keyValue = keyName.Length < line.Length - 1 ? line.Substring(splitPos + 1, line.Length - 1 - splitPos) : "";
                ...
                {
                    if (argException.Message.Contains("已添加项。"))
                    {
                        continue;
                    }
                }
        ...
        public bool KeyExists(string sectionName, string keyName)
        {
            ...
            return sections.ContainsKey(sectionName) && ((Hashtable)sections[sectionName]).ContainsKey(keyName.Trim());
        }
        ...
        public void WriteString(string sectionName, string keyName, string stringValue)
        {
            ...
            //if (!sections.ContainsKey(sectionName))
            sectionsItem = !SectionExists(sectionName) ? AddSection(sectionName) : (Hashtable) sections[sectionName];
