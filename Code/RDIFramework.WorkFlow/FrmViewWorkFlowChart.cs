...
namespace RDIFramework.WorkFlow
{
    ...
    /// 
    /// </summary>
    public partial class FrmViewWorkFlowChart : BaseForm
    {
        private string workFlowId = "";
        private string workFlowInsId = "";

        public FrmViewWorkFlowChart(string wfId,string wfInsId,string title = "")
        {
            InitializeComponent();
        ...
        {
            var objBitmap = new Bitmap(1000, 800);
            ...
            try
            {
                ...
                ucImageView.AddImage(objBitmap);
            }
            catch (Exception ex)
            {
        ...
        private void DrawTaskBitmap(Graphics gc, string taskCaption, string operType, int x, int y, bool isPass, bool isCurrent, string taskDes)
        {
            ...
            {
                case "1"://启动节点
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\启动节点" + noPassflag);
                    break;
                case "2"://终止节点 
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\终止节点" + noPassflag);
                    break;
                case "3"://交互节点 
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\交互节点" + noPassflag);
                    break;
                case "4"://控制节点 
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\控制节点" + noPassflag);
                    break;
                case "5"://查看节点 
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\查看节点" + noPassflag);
                    break;
                case "6"://子流程节点 
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\子流程节点" + noPassflag);
                    break;
                default:
                    taskBitmap = new Bitmap(SystemInfo.StartupPath + @"\Resource\WFImage\查看节点" + noPassflag);
                    break;
