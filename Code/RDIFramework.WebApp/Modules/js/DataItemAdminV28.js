...
$(function () {
    ...
    autoResize({ treegrid: '#dicGrid', gridType: 'treegrid', callback: mygrid.databind, height: 4, width: 204 });
    ...
    init: function (size) {
        ...
        center.panel({
            onResize: function (w, h) {
                $('#dicGrid').treegrid('resize', { width: w, height: h });
            }
        });
    },
...
var DicCategory = {
    bindTree: function () {
        $('#dataDicType').tree({
            url: 'handler/DataItemAdminHandler.ashx?action=GetDataItem',
    ...
    addCategory: function () {
        var addDialog = top.$.hDialog({
            title: '添加字典类别',
            iconCls: 'icon16_add',
            href: 'Modules/html/DataItemV28.htm?n=' + Math.random(),
            width: 400,
            height: 340,
            onLoad: function () {
...
var mygrid = {
    ...
    add: function() {
        ...
        dicDialog = top.$.hDialog({
            href: 'Modules/html/DataItemDetailV28.htm?n=' + Math.random(),
            width: 400,
            height: 400,
            title: '新增选项明细',
