    ...
    init: function() {
        $('#organizeTree').tree({
            ...
            onLoadSuccess:function(node,data) {
                ...
                /*
                var children = $('#organizeTree').tree('getChildren', node.target);              
                var arr = [];
                arr.push(depId);
                ...
                $('#staffGird').datagrid('load', { filter: JSON.stringify(filterObj) });
                */
        ...
        var addDialog = top.$.hDialog({
            ...
            submit: function () {
                ...
                if (top.$('#uiform').form('validate')) {
                    ...
                    queryString = 'OrganizeId=' + vOrganizeId + '&' + queryString;
        ...
        if (row != null) {
            var ad = top.$.hDialog({
                ...
                submit: function () {
                    ...
                    if (node) {
                        $.ajaxtext(actionUrl, 'action=MoveTo&staffId=' + row.ID + '&organizeId=' + node.id, function (d) {
                            if (d > 0) {
                                msg.ok('移动成功！');
                                mygrid.reload();
                                ad.dialog('close');
