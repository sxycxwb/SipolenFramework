...
* 修改记录：
*   5、2016-02-29 XuWangBin V3.0 增加用户离职、用户界面查看日志。
*   4、2015-04-13 XuWangBin V2.9 重新设计查询功能、优化整个代码。
*   3、2014-07-07 XuWangBin V2.8 修改用户管理主界面以组织机构方式进行管理，并用分页的方式展示。
*   2. 2013-12-23 XuWangBin V2.7 优化代码，提高加载速度、重新设计本界面。
*   1. 2013-08-12 XuWangBin V2.5 新增本业务逻辑的编写。
*/
