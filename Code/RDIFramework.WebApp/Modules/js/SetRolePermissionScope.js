...
RolePermissionScope.prototype = {
    ...
    bindUser: function () {
        var query = 'action=GetScopeUserIdsByRoleId&roleId=' + this.obj.ID;
    ...
    bindRole: function () {
        var query = 'action=GetScopeRoleIdsByRoleId&roleId=' + this.obj.ID;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (arr) {
            if (arr.length > 0) {
    ...
    bindOrganize:function() {
        var query = 'action=GetScopeOrganizeIdsByRoleId&roleId=' + this.obj.ID;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (arr) {
            if (arr.length > 0) {
    ...
    bindModule: function () {
        var query = 'action=GetScopeModuleIdsByRoleId&roleId=' + this.obj.ID;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (arr) {
            if (arr.length > 0) {
    ...
    bindPermissionItem: function () {
        var query = 'action=GetScopePermissionItemIdsByRoleId&roleId=' + this.obj.ID;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (arr) {
            if (arr.length > 0) {
    ...
    saveUserScope: function () {
        ...
        var query = 'action=SaveRoleUserScope&targetRoleId=' + this.obj.ID + "&userIds=" + uIds;
    ...
    saveRoleScope: function () {
        ...
        var query = 'action=SaveRoleRoleScope&targetRoleId=' + this.obj.ID + "&roleIds=" + rIds;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (d) {
            if (d.Data > 0) {
                msg.ok(d.Message);
            } else {
    ...
    saveOrganizeScope: function () {
        ...
        var query = 'action=SaveRoleOrganizeScope&targetRoleId=' + this.obj.ID + "&organizeIds=" + orgIds;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (d) {
            if (d.Data > 0) {
                msg.ok(d.Message);
            } else {
    ...
    saveModuleScope: function () {
        ...
        var query = 'action=SaveRoleModuleScope&targetRoleId=' + this.obj.ID + "&moduleIds=" + mIds;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (d) {
            if (d.Data > 0) {
                msg.ok(d.Message);
            } else {
    ...
    savePermissionItem: function () {
        ...
        var query = 'action=SaveRolePermissionItemScope&targetRoleId=' + this.obj.ID + "&permissionItemIds=" + pIds;
        $.ajaxjson('handler/ResourcePermission.ashx', query, function (d) {
            if (d.Data > 0) {
                msg.ok(d.Message);
            } else {
