...
public partial class Utils
{
    ...
    {
        return RDIFrameworkKeys.ASSEMBLY_VERSION;
    }
    #endregion
    ...
    public static bool SqlFilter(string word, string InText)
    {
        if (InText == null)
            return false;
        return word.Split('|').Any(i => (InText.ToLower().IndexOf(i + " ") > -1) || (InText.ToLower().IndexOf(" " + i, System.StringComparison.Ordinal) > -1));
    }
    #endregion
    ...
    {
        return string.IsNullOrEmpty(oldStr) ? "" : originalStr.Replace(oldStr, newStr);
    }
    ...
    {
        return string.IsNullOrEmpty(str) ? "" : HttpContext.Current.Server.UrlDecode(str);
    }
    ...
    public static string CombUrlTxt(string _url, string _keys, params string[] _values)
    {
        ...
        try
        {
            ...
            {
                if (string.IsNullOrEmpty(_values[i]) || _values[i] == "0") continue;
