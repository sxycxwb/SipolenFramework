...
namespace RDIFramework.WebApp.CommonUtils
{
    public class NVelocityUtils
    {
        ...
        public NVelocityUtils():this(null) { }

        public NVelocityUtils(string templatePath) 
        {
        ...
        public string FileToString(string templatFileName)
        {
            ...
            //从文件中读取模板
            var template = velocity.GetTemplate(templatFileName);
            //合并模板
        ...
        public void SaveFile(string templateFileName, string saveFileName)
        {
            ...
            using (var sw = new StreamWriter(saveFileName,false,Encoding.UTF8))
            {
