<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnClaimedTask.aspx.cs" Inherits="RDIFramework.WebApp.WorkFlow.UnClaimedTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="toolbar">
        ...
        <a id="btnClaimTask" plain="true" class="easyui-linkbutton" icon="icon16_action" title="查询">认领任务</a>          
    </div>
    <!--用于数据显示-->    
    <table id="list"></table>    
    <script type="text/javascript" src="js/UnClaimedTask.js?v=30"></script>
</asp:Content>
