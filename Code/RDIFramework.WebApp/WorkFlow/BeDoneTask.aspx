<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeDoneTask.aspx.cs" Inherits="RDIFramework.WebApp.WorkFlow.BeDoneTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" src="../Content/Scripts/My97DatePicker/WdatePicker.js"></script>
         ...
         <div id="toolbar">
            ...
            <a id="btnViewTask" plain="true" class="easyui-linkbutton" icon="icon16_eye" title="查看任务">查看任务</a> 
    ...
    <script type="text/javascript" src="js/BeDoneTask.js?v=30"></script>
</asp:Content>
