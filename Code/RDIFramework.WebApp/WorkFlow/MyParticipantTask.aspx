<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyParticipantTask.aspx.cs" Inherits="RDIFramework.WebApp.WorkFlow.MyParticipantTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="toolbar">
        ...
        <a id="btnViewTask" plain="true" class="easyui-linkbutton" icon="icon16_door" title="处理任务">查看任务</a>          
    ...
    <script type="text/javascript" src="js/MyParticipantTask.js?v=30"></script>
</asp:Content>
