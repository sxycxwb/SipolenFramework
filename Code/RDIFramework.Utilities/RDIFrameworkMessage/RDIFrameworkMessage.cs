...
namespace RDIFramework.Utilities
{
    ...
    /// 
    /// 修改记录
    ///     2013-10-20 XuWangBin 2.7 重新组织，使用了partial进行了更明确的功能分类。
    ///     2013-10-08 XuWangBin 2.7 新增工作流部分消息。
    ///     2013-03-01 XuWangBin 2.0 新增了表字段服务相关方法对应消息。
    ///     2012-06-06 XuWangBin 1.5 重新组织了整个基类，使得结构更为清晰。
    ///		2012.02.17 XuWangBin 1.0 建立，为了提高效率分开建立了类。
    ///	
    /// 版本：2.7
    ///
    /// <author>
    ...
    public partial class RDIFrameworkMessage
    {
        ...
        /// 确认关闭吗？
        /// </summary>
        public static string MSG0102 = "确认关闭吗？";
