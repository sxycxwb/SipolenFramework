...
namespace RDIFramework.Utilities
{
	...
	/// 修改纪录
	/// 
	///     2015-04-11 XuWangBin 版本：2.9 转为自动属性。
    ///     2013.12.20 XuWangBin 版本: 2.7 对属性增加了说明。
	///		2011.09.12 XuWangBin 版本：2.1 公司名称、部门名称、工作组名称进行重构。
	///		2011.05.11 XuWangBin 版本：2.0 增加安全通讯用户名、密码。
	///		2008.08.26 XuWangBin 版本：1.2 整理主键。
	///		2006.05.03 XuWangBin 版本：1.1 添加到工程项目中。
	///		2006.01.21 XuWangBin 版本：1.0 远程传递参数用属性才可以。
	///		
	/// 版本：3.0
	///
	/// <author>
