...
namespace RDIFramework.Utilities
{
    ...
    public class LunarCalendarHelper
    {
        ...
        public LunarCalendarHelper(DateTime dt)
        {
            ...
            TimeSpan ts = _date - LunarCalendarHelper.MinDay;//计算两天的基本差距
            offset = ts.Days;
        ...
        public LunarCalendarHelper NextDay()
        {
            ...
            return new LunarCalendarHelper(nextDay);
        }
        #endregion
        ...
        public LunarCalendarHelper PervDay()
        {
            ...
            return new LunarCalendarHelper(pervDay);
        }
        #endregion
