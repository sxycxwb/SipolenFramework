...
namespace RDIFramework.Utilities
{
    ...
    /// 汉字转拼音工具
    /// </summary>
    internal sealed class CHS2PinYinHelper
    {
        /// <summary>
        /// 包含字符 ASC 码的整形数组。
        /// </summary>
        ...
        internal static string Convert(string chs, string separator, bool initialCap)
        {
            ...
            // 例外词组
            foreach (DictionaryEntry de in CHS2PinYinHelper.Phrase)
            {
        ...
        {
            return CHS2PinYinHelper.Convert(chs, separator, false);
        }
        ...
        {
            return CHS2PinYinHelper.Convert(chs, "", initialCap);
        }
        ...
        {
            return CHS2PinYinHelper.Convert(chs, "");
        }
        ...
        {
            return CHS2PinYinHelper.Convert(chs).Length > 0 ? CHS2PinYinHelper.Convert(chs).Substring(0, 1).ToUpper() : "";
        }
