...
namespace RDIFramework.Utilities
{
    ...
    public class FileHelper : IDisposable
    {
        ...
        /// 构造函数
         ...
         #region void WriteException(UserInfo userInfo, Exception ex):写入异常情况
         /// <summary>
         /// 写入异常情况
         /// </summary>
         ...
         #region void WriteException(Exception ex, string fileName):写入异常情况
         /// <summary>
         /// 写入异常情况
         /// </summary>
         /// <param name="ex">异常</param>
         ...
         public static void WriteException(Exception ex, string fileName)
         {
             ...
             // 将异常信息写入本地文件中
             var writerFileName = SystemInfo.StartupPath + @"\log\" + fileName;
             ...
             var streamWriter = new StreamWriter(writerFileName, true, Encoding.Default);
             streamWriter.WriteLine(DateTime.Now.ToString(SystemInfo.DateTimeFormat) + " Message:" + ex.Message 
