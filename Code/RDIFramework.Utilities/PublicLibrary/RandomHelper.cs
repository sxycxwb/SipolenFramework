...
namespace RDIFramework.Utilities
{
    ...
    ///		2007.06.30 版本：3.2 XuWangBin   产生随机字符。
    ///		2006.02.05 版本：3.1 XuWangBin   重新调整主键的规范化。
    ///		2004.11.12 版本：3.0 XuWangBin   最后修改，改进成以后可以扩展到多种数据库的结构形式。
    ///	    2004.11.12 版本：3.0 XuWangBin   一些方法改进，主键格式优化，基本上看上去还过得去了。
    ///     2005.03.07 版本：2.0 XuWangBin   2005.03.07 更新程序排版。
    ///     2005.08.13 版本：1.0 XuWangBin   参数格式标准化。
    ///     
    /// 版本：3.2
	/// <author>
	///		<name>XuWangBin</name>
