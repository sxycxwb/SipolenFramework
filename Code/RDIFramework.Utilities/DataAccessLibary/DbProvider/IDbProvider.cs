...
namespace RDIFramework.Utilities
{
    ...
    public interface IDbProvider : IDisposable
	{
		...
		/// <returns>参数</returns>
		IDbDataParameter MakeParam(string parameterName, object parameterValue, DbType dbType, Int32 parameterSize, ParameterDirection parameterDirection);
        ...
        /// <returns>数据表</returns>
        DataTable GetDTByPage(out int recordCount, string tableName, int pageIndex, int pageSize, string conditions, string orderby);
