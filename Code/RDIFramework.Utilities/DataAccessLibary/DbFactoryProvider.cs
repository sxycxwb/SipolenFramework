...
namespace RDIFramework.Utilities
{
    ...
    /// 修改纪录
    /// 
    ///     2015-09-10 版本：3.0 XuWangBin 重新重构。
    ///		2011.10.09 版本：2.1 XuWangBin 改进直接用数据库连接就可以打开连接的方法。
    ///		2011.10.08 版本：2.0 XuWangBin 支持多类型的多种数据库。
    ///		2011.09.18 版本：1.4 XuWangBin 整理代码注释。
    ///		2011.07.23 版本：1.2 XuWangBin 每次都获取一个新的数据库连接，解决并发错误问题。
    ///		2010.09.23 版本：1.1 XuWangBin 优化改进为单实例模式。
    ///		2010.08.26 版本：1.0 XuWangBin 创建数据库服务工厂。
    /// 
    /// 版本：3.0
    /// 
    /// <author>
