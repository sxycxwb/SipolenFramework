...
namespace RDIFramework.WinForm.Utilities
{
    ...
    /// 插件配置管理
    /// </summary>
    public class AddinManagement
    {
        string fileAddin = Application.StartupPath + @"\\RDIFramework.AddIn";
        ...
        public AddinManagement(string AssemblyGuid)
        {
