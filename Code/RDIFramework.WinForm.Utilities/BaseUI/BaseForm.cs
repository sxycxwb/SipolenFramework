...
namespace RDIFramework.WinForm.Utilities
{
    ...
    /// 修改纪录
    /// 
    ///     2014-07-16 EricHu V2.8 增加鼠标忙与闲的统一控制。
    ...
    /// </author> 
    /// </summary>
    public class BaseForm: Office2007Form, IBaseForm
    {       
        ...
        #region public void ShowFormInMainTab(BaseForm mdiForm, string code, Image pageImage) 把窗体显示在主界面的Tab中
        /// <summary>
        /// 用于Tab关闭时刷新主界面
        /// </summary>
        public delegate void FormClosedRefreashEventHandler();
