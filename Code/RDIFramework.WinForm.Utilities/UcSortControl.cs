...
namespace RDIFramework.WinForm.Utilities
{
    ...
    public partial class UcSortControl : UserControl
    {
        ...
        public int SetTop()
        {
            ...
            string targetId = "";
            if (dataTableFlag)
                targetId = SortLogic.GetPreviousId(this.dataView, this.EntityId);
            else
            {
                targetId = SortLogic.GetPreviousIdDyn(lstT, this.EntityId);
            }
        ...
        public int SetUp()
        {
            ...
            if (dataTableFlag)
                ...
                targetId = SortLogic.GetPreviousIdDyn(this.lstT, this.EntityId);
            if (targetId.Length > 0)
            {
                if (dataTableFlag)
